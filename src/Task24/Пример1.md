...
Есть сложный запрос, который выполняет поиск адресов в таблице, в которых содержится переданная строка
...
Выполним тот запрос напрямую к бд
...
Запрос занял 1мс. Прирост производительности получился в 4 раза.
