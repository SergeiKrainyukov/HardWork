...
Занятие позволило обратить внимание на то, что часто и я, и другие программисты "предполагаем", как работает та или
иная функция и на основе собственных предположений строим логику нашего приложения. Иногда кажется, что глубоко
в чем-то разбираться нет времени, надо выкатить решение в срок, и полагаешься на интуицию, что в большинстве случаев
срабатывает. Однако, если "тушить пожар" в моменте не нужно, то прежде чем пользоваться какой-либо функцией или апи
надо конечно уточнить механизм и пространство возможных вариантов ее работы. Иначе рано или поздно такой интуитивный подход
приведет к ошибкам. С другой стороны, разрабатывая какой-либо модуль, надо самому делать так, чтобы другим
разработчикам не приходилось угадывать, как работает та или иная функция, и либо писать документацию, либо
комментарии, либо быть как можно более конкретным в реализации, как я попытался сделать в вышеприведенных примерах.