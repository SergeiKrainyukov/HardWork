...
### Выводы
Дефункционализация действительно является мощной техникой рефакторинга, позволяющей структурировать код, делая его более понятным и поддерживаемым.
Данные намного проще тестировать, чем функции, так как они не зависят от контекста выполнения. Во время выполнения задания
придумал еще несколько областей из практики андроид-разработки, где это можно было бы применить. Ранее подобные
операции делал интуитивно, спонтанно, либо просто копируя такой подход откуда-то из другой части системы или
у другого разработчика, не задумываясь о том, откуда растут корни. Занятие было очень полезным, буду более осознанно применять
на практике.
